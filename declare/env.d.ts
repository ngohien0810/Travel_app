declare module '@env' {
  ...
  export const ANDROID_KESTORE_FILE: string;
  export const ANDROID_KESTORE_PASSWORD: string;
  export const ANDROID_KESTORE_KEY_ALIAS: string;
  export const ANDROID_KESTORE_KEY_PASSWORD: string;
}
