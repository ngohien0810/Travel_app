 ...
 */
export const sharedTiming = (toValue: number, config?: WithTimingConfig, callBack?: AnimationCallback) => {
    'worklet';
    return withTiming(
        toValue,
        Object.assign(
 ...
 */
export const sharedSpring = (toValue: number, config?: WithSpringConfig, callBack?: AnimationCallback) => {
    'worklet';
