...
export const checkPasswordContainUserName = (username: string, password: string) => {
 ...
 */
export const stringifyObjectValidateYup = ({ keyT, options, optionsTx }: ValidateMessageObject) => {
