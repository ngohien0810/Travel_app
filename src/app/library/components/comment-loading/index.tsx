...
export const CommentLoading = ({ overlayColor = OVERLAY_COLOR }: CommentLoadingProps) => {
    // state
    ...
    const renderItem = (item: number) => {
        return reRender ? null : <ItemComment overlayColor={overlayColor} key={item} index={item} />;
    };
