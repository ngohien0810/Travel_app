...
export const Collapsible = ({ children, renderContent, renderMasterView }: CollapsibleProps) => {
    // state
    ...
    return (
        <View>
            <Animated.View pointerEvents={'none'} onLayout={onLayoutContent} style={[styles.base, styles.hiddenView]}>
