...
import Animated, { measure, runOnUI, useAnimatedRef, useAnimatedStyle, useSharedValue } from 'react-native-reanimated';
...
export const DropDown = forwardRef((props: DropDownProps, _) => {
    ...
    const isRenderOnBottom = useMemo(() => {
        return deviceH - (wrapMeasured.value.y + inset.top + wrapMeasured.value.height) > dropHeight.value + 50;
