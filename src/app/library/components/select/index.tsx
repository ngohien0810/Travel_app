...
import { FlatList, ListRenderItemInfo, StyleProp, Text, TouchableOpacity, View, ViewStyle } from 'react-native';
                ...
                >
                    <View>
                        <View style={[styles.content, content]}>
                            <FlatList data={data} keyExtractor={keyExtractor} renderItem={renderItem} {...rest} />
                        </View>
                    </View>
                </Modal>
            </View>
