...
export const SliderLinear = ({
    ...
    const translateX = useDerivedValue(() => sharedClamp(translationX.value, -THUMB_SIZE, width - THUMB_SIZE));
    const progressValue = useInterpolate(translateX, [-THUMB_SIZE, width - THUMB_SIZE], [lowerBound, upperBound]);
    // function
    ...
    // effect
    useEffect(() => {
        const percentLeft = (initialLinear - lowerBound) / (upperBound - lowerBound);
