...
export const ProgressCircle = ({
    ...
    const strokeDashoffset = useDerivedValue(
        () => interpolate(progressValue.value, [0, 100], [Math.PI * 2, 0], Extrapolate.CLAMP) * radius
    );
    ...
    return (
        <View style={styles.container}>
            {showTextProgress && (
                <AnimatedText style={[styles.textProgress, textProgressStyle]} children={renderText()} />
            )}
