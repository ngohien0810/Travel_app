...
export const Skeleton = ({
    ...
    // effect
    useEffect(() => {
        translateX.value = withRepeat(sharedTiming(screenWidth, { duration: 2000 }), -1, false);
    ...
    return (
        <MaskedView
            ...
            maskElement={<View style={[styles.wrapChildren]}>{children ? children : <BaseContent />}</View>}
        >
            <View style={[overlay]} />
