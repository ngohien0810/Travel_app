...
function ScreenWithoutScrolling(
    ...
    return (
        <>
            <Wrapper edges={edges} style={[styles.inner, style, backgroundColor ? { backgroundColor } : {}]}>
...
export const Screen = (props: ScreenProps) => {
    ...
    const actualUnsafe = useMemo<boolean>(() => props.unsafe || edges.length <= 0, [edges.length, props.unsafe]);
